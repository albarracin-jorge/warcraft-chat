...
const badgeVariants = cva(
  "fantasy inline-flex items-center gap-1.5 transition-all duration-100 focus:outline-none focus:ring-2 focus:ring-amber-500/50 [border-image-repeat:stretch] border-solid",
  {
    variants: {
      variant: {
        default:
          "text-amber-100 [text-shadow:0_0_8px_rgba(251,191,36,0.4)] [border-image-source:url('https://www.warcraftcn.com/warcraftcn/button-bg-with-frame.webp')] [border-image-slice:16_fill]",
        secondary:
          "text-slate-200 [border-image-source:url('https://www.warcraftcn.com/warcraftcn/button-bg.webp')] [border-image-slice:16_fill]",
        destructive:
          "text-red-200 [text-shadow:0_0_8px_rgba(239,68,68,0.4)] [border-image-source:url('https://www.warcraftcn.com/warcraftcn/button-bg-with-frame.webp')] brightness-75 hue-rotate-[320deg] [border-image-slice:16_fill]",
        outline:
