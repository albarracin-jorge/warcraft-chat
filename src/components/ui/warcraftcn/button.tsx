...
function Button({
  ...
  const borderImageClass =
    variant === "frame"
      ? "[border-image-source:url('https://www.warcraftcn.com/warcraftcn/button-bg-with-frame.webp')]"
      : "[border-image-source:url('https://www.warcraftcn.com/warcraftcn/button-bg.webp')]";
